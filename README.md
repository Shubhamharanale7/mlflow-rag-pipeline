...
3\. \*\*RAG Tuning\*\* — `tune\_rag.py` runs experiments tracked by MLflow
...
├── tune\_rag.py                  # RAG hyperparameter tuning

├── generating\_qa\_dataset.ipynb  # QA dataset generation notebook

├── pg\_eval\_dataset\_index.json   # Evaluation dataset
...
HUGGINGFACE\_API\_KEY=your\_key\_here
...
\- Run `generating\_qa\_dataset.ipynb` notebook
...
mlflow models serve -m runs:/<run\_id>/rag\_deployment -p 5001
